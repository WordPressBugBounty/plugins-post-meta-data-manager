...
?><div id="pmdm_wp_term_metabox" class="postbox user_custom_metabox">
    ...
    <div class="postbox-header">
        <h2 class="hndle ui-sortable-handle"><?php echo esc_html__( 'Term Metadata Manager', 'post-meta-data-manager' ); ?></h2>
    </div>
                ...
                foreach( $term_meta as $meta_key => $value ) {
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
									<a href="javascript:;" data-id="<?php echo esc_html( $meta_key ); ?>" id="edit-<?php echo esc_html( $meta_key ); ?>" class="edit-meta"><?php echo esc_html__( 'Edit', 'post-meta-data-manager' ); ?></a> 

                                    <div id="javascript:;" class="modal-window">
                                        <div>
                                            <a href="javascript:;" title="Close" class="modal-close">x</a>
											<h1><strong><?php echo esc_html__( 'Currently you are editing', 'post-meta-data-manager' ); ?></strong>: <?php echo esc_html($meta_key); ?></h1>
                                            <div class="model-body">
                                                ...
                                                ?>
                                                    ...
                                                    <input type="submit" value="<?php echo esc_html__( 'Change', 'post-meta-data-manager' ); ?>" class="change_btn" />
                                    ...
                                    | 
									<a href="javascript:;" data-id="<?php echo esc_html( $meta_key ); ?>"  id="delete-<?php echo esc_html($meta_key); ?>" class="delete-meta"><?php echo esc_html__( 'Delete', 'post-meta-data-manager' ); ?></a>
                                </td>
                            </tr>
